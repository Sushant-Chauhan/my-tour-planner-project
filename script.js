onload = function () {
    ...
    const cities = ['Taj Mahal,Agra', 'Golden Temple,Amritsar', 'Red Fort,New Delhi', 
    ' Lotus Temple,Delhi', 'Braham Sarovar,Kurukshetra', 'Mysore Palace,Karnataka', 
    'Morni Hills,', 'Ooty,Tamil Nadu', 'Hawa Mahal,Jaipur', 'ISKCON Temple,Bangalore'];
